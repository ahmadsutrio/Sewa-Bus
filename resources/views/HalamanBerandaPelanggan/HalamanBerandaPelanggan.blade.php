<?php
class HalamanBerandaPelanggan
{
    public function tampil()
    {
        $daftarBus = Bus::ambil();
        return view('HalamanBerandaPelanggan/HalamanBerandaPelanggan', [
            'title' => 'Beranda',
            'data' => $daftarBus,
        ]);
    }
...
<script>
    function kalkulasi() {
        ...
        var dp = harga * lamaPenyewaan * 10 / 100;
        console.log(lokasi);
        console.log(lamaPenyewaan);
        console.log(harga);
        console.log(total);
        document.getElementById("hasilAkir").value = total;
        document.getElementById("dp").value = dp.toString();
    }
</script>
                                            ...
                                            <form action="{{ route('sewa') }}" method="post" enctype="multipart/form-data"
                                                ...
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="modal-body row justify-content-center ">
                                                        ...
                                                        <label for="formFile" class="">Bukti Foto</label>
