...
@section('content')
    ...
    <div class="section-koleksi  mt-5 py-2 ">
        <div class="ms-lg-5 ms-2 me-1 me-lg-5 row ">
            <h2 class="fw-bold text-capitalize my-auto mt-3 mb-3 d-block w-100 ">daftar semua Bus </h2>
            <div class="col ">
            ...
            @foreach ($data as $hapusItem)
                <div class="modal fade" id="hapus-{{ $hapusItem->idBus }}" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-body">
                                <p class="h5 text-center my-5">Apakah anda yakin akan menghapus <span
