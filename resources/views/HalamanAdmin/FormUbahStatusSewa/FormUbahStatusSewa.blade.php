...
@section('content')
    <div class="container-fluid mx-2 p-0 mt-5 overflow-auto">
        <div class="container mt-5">
            <h2 class="w-100 fw-bold">Pemesanan Bus</h2>
                            ...
                            <form action="" class="w-100 p-0 table-responsive">
                                ...
                                <tr class="">
                                    ...
                                    <td class="align-middle text-center">
                                        {{ $item->lokasiPenjemputan }},{{ $item->alamatPenjemputan }}</td>
                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{ url('Admin/penyewaan/' . $item->idSewa, $item->idBus) }}"
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td class="border-0">
                                                <label for="statusBus" class="bg-white fw-bold">Status Mobil</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="bg-white border-0 m-0 p-0">
